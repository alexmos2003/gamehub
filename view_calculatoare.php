...
<div class="grid-container">
  <div class="grid-x grid-padding-x">
    <div class="large-12 cell">
      <h2 style="font-size:42px;margin:10px 0 20px;">Toate calculatoarele</h2>
      </br>

      <?php
      $db2 = new mysqli("localhost", "root", "", "gamehub");
      if ($db2->connect_error) die("Connection failed: " . $db2->connect_error);
      $sqlv = "SELECT id, name, description, price, image_url FROM tabel_calculatoare";
      ...
      <a href="admin_calculatoare.php" class="button">Înapoi</a>
      <?php $db2->close(); ?>
    </div>
  </div>
</div>
