...
<div class="grid-container">
        <div class="grid-x grid-padding-x">
            <div class="large-12 cell">
                ...
                $SW = 0;
                if (empty($_POST["name"])) {
                    $nameErr = "Este necesar numele jocului.";
                    echo $nameErr;
                } else {
                    $name = $_POST["name"];
                    $sql = "SELECT id, name, description, image_url FROM tabel_jocuri WHERE name LIKE '%$name%'";
                    $SW = 1;
                }
                ...
                if ($SW == 1) {
                    ...
                    if ($nr > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "</td><td>";
                            echo "<a href='modificare.php?id=" . $row["id"] . "' class='button'>Edit</a>";
                            echo "</td></tr>";
                        }
                        echo "</tbody></table>";
                    } else {
